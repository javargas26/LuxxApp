package com.example.telematica.luxxapp;
...
import com.example.telematica.luxapp.R;
...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(DeviceListActivity.this)) {
            Toast.makeText(DeviceListActivity.this,"Gps already enabled",Toast.LENGTH_SHORT).show();
        ...
        if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER) && hasGPSDevice(DeviceListActivity.this)) {
            ...
            Toast.makeText(DeviceListActivity.this,"Gps not enabled",Toast.LENGTH_SHORT).show();
            enableLoc();
        }else{
            Log.e("keshav","Gps already enabled");
            Toast.makeText(DeviceListActivity.this,"Gps already enabled",Toast.LENGTH_SHORT).show();
